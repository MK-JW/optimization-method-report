function [x_optimal,f_optimal,k]=Steepest_Descent_InexactSearch(f_test,g_test,x_initial,tolerance)
%==========================================================================
%函数调用格式：
%[x_optimal,f_optimal,k]=Steepest_Descent_InexactSearch(f_test,g_test,x_initial,tolerance)
%--------------------------------------------------------------------------
%输入参数说明
%--------------------------------------------------------------------------
%f_test：目标函数
...
fprintf(fileID2,'%4.0f%15.6f%15.6f%15.6f\r\n',k,x_current,f_current);
%----------------------------------------------------------------------
%[alpha_acceptable,x_next,f_next,ki]=Wolfe_search(f_test,g_test,x_current,d_current,rho,sigma);
%---------------------------------------------------------
a1 = inex_lsearch_01(x_current,d_current,f_test,g_test);
x_next=x_current+a1*d_current;
