function [x_optimal,f_optimal,k]=Steepest_Descent_Armijo(f_test,g_test,x_initial,tolerance)
%==========================================================================
%函数调用格式：
...
%搜索步长采用Armijo_mk非精确方法，其中步长最小值可精确到1e-15
%实际中，采用步长最小值不小于1e-6
%--------
%%[x_next,f_next]=armijo_mk(f_test,g_test,x_current,d_current)
%----
%--------------------------------------------------------------------------
k=0;
