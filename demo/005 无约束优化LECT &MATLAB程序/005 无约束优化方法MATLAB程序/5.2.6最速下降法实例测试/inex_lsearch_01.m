...
%        It is a string (e.g. 'rho = 0.1') and can be a combination
%        several internal parameters (e.g., 'rho = 0.25; sigma=0.5').
...
%        with all components numerically specified. The components 
%        of p2 must appear in the same order as they appear 
%        in function F and gradient G. For example, if p2=[a b], 
%        then F.m and G.m must be in the form of function z = F(x,p2)
%        and function z = G(x,p2)
%  Output:
...
%==========================================================================
function z = inex_lsearch_01(xk,s,f_test,g_test,p1,p2)
k = 0;
m = 0;
tau = 0.1;
chi = 0.75;
