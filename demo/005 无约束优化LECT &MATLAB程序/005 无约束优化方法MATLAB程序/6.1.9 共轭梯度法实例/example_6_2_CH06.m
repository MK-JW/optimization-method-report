function example_6_2_CH06
close;
clear;
clc;
%-----------------------------------------------
%刘兴高-应用最优化方法及MATLAB实现CH06-6.2
%例6.1  目标函数f(x)=x1^2+x2^2+x1*x2+2;
%  x0=(1;-4);  tol=1e-6
%------------------------------------------------
x_initial=[1;-4];
tolerance=1e-6;
[x_optimal,f_optimal,k]=Conjugate_gradient_DY(@f_test2,@g_test2,x_initial,tolerance)
t=-4.5:0.1:4.5;
[X1,X2]=meshgrid(t);
Y=X1.^2+X2.^2+X1.*X2+2;
%---------------------------------------------------------------------
