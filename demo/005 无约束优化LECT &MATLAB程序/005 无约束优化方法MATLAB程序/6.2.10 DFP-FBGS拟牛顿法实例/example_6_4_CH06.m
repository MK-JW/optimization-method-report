function example_6_4_CH06
close;
clear;
clc;
%-----------------------------------------------
%刘兴高-应用最优化方法及MATLAB实现CH06-6.4
%例6.4  目标函数f(x)=-0.8*exp(-x1^2-4*x2^2);
%  x0=(1;1);  tol=1e-6
%------------------------------------------------
x_initial=[1;1];
tolerance=1e-6;
[x_optimal,f_optimal,k]=DFP_Wolfe(@f_test1,@g_test1,x_initial,tolerance)
t=-3:0.1:3;
[X1,X2]=meshgrid(t);
