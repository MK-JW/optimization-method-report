...
cvx_begin
    variable x(n)  
    minimize (x(1)-5*x(2)+4)^2+(7*x(1)+11*x(2)-18)^4
cvx_end
f_star = cvx_optval;
...
while gak > epsi
      ...
      h=ezplot(@(xt,yt)ellipse(xt,yt,xx0,AA0),[-6,12,-6,12]);
